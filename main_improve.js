				    ...
				    initialize: function(x){
				        ...
				        this.addEventListener('enterframe', function(){//console.log(" "+player.X_blockTouched+" "+player.Y_blockTouched+" ");
				        	if(this.intersect(player)){
				        		...
				        		player.blockY2 = this.y+12;
				        		//top side
				        		if(player.y<=this.y+2&&player.x<=this.x+28&&player.x>=this.x-4){
				        			player.Y_touched(this.x, this.y-20, mouseY);
				        			player.Ytouch = 1;
				        		}//bottom side
				        		else if(player.y>=this.y+8&&player.x<=this.x+28&&player.x>=this.x-4){
				        			player.Y_touched(this.x, this.y+12, mouseY);
				        			player.Ytouch = 2;
				        		}//right side
				        		else if(player.x>=this.x+30&&player.y>=this.y+2&&player.y<=this.y+10){
				        			player.X_touched(this.x+33, this.y, mouseX);
				        			player.Xtouch = 1;
				        		}//left side
				        		else if(player.x<=this.x+2&&player.y>=this.y+2&&player.y<=this.y+10){
				        			player.X_touched(this.x-21, this.y, mouseX);
				        			player.Xtouch = 2;
				        		}
				        	}
				        	if(this.y<=34){
